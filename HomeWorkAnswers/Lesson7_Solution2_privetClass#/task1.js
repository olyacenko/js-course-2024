...
const studentsGroup = new StudentsGroup();
...
document.querySelector("#btnAdd").addEventListener("click", () => {
    ...
    const isValidId = studentsGroup.isValidId(id);
...
document.querySelector("#btnInfo").addEventListener("click", () => {
    ...
    if (id === null || !isValidId) {
        ...
        showResult(studentsGroup.info(id), "#infoOutput");
        clearInput("#idInfo");
    }
});

document.querySelector("#btnList").addEventListener("click", () => {
    showResult(studentsGroup.list(), "#listOutput");
});
